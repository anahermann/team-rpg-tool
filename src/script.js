...
{tipo:"Navegador", descricao:"Fornece direcionamento para o time",
  cor:"orange",
   quests:[
	...
	{texto: "Descrever um teste para a fase 'red' em red-green-refactor.", niveis:[0,1]},
	{texto: "Manter foco no passo atual do red-green-refactor.", niveis:[1,2,3]},
...
{tipo:"Participante", descricao:"Ajuda o time a superar o desafio",
  cor:"darkgreen", 
   quests:[
	...
	{texto: "Apoiar ideia de Participantes menos ouvidos.", niveis:[1,2,3]},
	{texto: "Identificar uma oportunidade de refatoração.", niveis:[2,3]},
	{texto: "Celebrar um momento de excelência.", niveis:[1,2,3]},
	{texto: "Pesquisar a resposta para uma dúvida.", niveis:[0,1]}
  ]}
  ];
...
function createScoring(elementoAvo, nome) {
  ...
  btnConfirm.setAttribute("title", "Somar Pontos");
...
function createPessoaHeader(elementoAvo, nome) {
  ...
  btnDelete.setAttribute("title", "Remover pessoa");
...
function rotate() {
	...
	var qtd = document.getElementById("qtdRotacao");
